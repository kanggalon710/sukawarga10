...
<div class="card" id="panelInfo" style="display:none;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-top:16px;">
        ...
        <div style="grid-column:span 2;"><label for="alamat_portal" style="display:block; font-size:12px; font-weight:600; margin-bottom:6px;">Alamat Portal</label><input type="text" id="alamat_portal" name="alamat_portal" value="{{ $settings['alamat_portal'] ?? 'paru.jabnet.id' }}" maxlength="100" style="width:100%; padding:10px; border:1.5px solid var(--abu2); border-radius:var(--radius-sm); font-size:14px;" placeholder="paru.jabnet.id"><div style="font-size:11px; color:var(--text3); margin-top:4px;">Nama domain saja, tanpa https:// dan tanpa garis miring. Dipakai di pesan WhatsApp ke warga.</div></div>
